...
class PtolemyMappingSpec extends FlatSpec with MustMatchers {

  "PtolemyMapping" should "enable combination of mappings" in {
  ...
  "PtolemyMapping" should "enable combination of mappings 2" in {
    val ptolemy                 = new Ptolemy()
  ...
  "PtolemyMapping" should "work with nested fields" in {
    val ptolemy = new Ptolemy
